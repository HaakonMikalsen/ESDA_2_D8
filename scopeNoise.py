...
dataFile = codecs.open(dir_path+"/data/"+"zoom in noise scope.csv", encoding="utf-8", errors="ignore")
skipLinesStart = 27
skipLinesEnd = None
...
plt.gca().xaxis.set_major_formatter(mticker.FormatStrFormatter("%.2f ms"))
...
#     label="vi"
# )
plt.savefig("./bilder/noiseScope.png")
plt.show()